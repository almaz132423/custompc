...
export class CompatibilityRulesController {
  ...
  @Post()
  create(@Body() dto: CreateCompatibilityRuleDto) { return this.service.create(dto); }

  @Patch(':id')
  update(@Param('id') id: string, @Body() dto: UpdateCompatibilityRuleDto) { return this.service.update(id, dto); }
